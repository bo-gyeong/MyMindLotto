...
public class MakeMainList extends BaseAdapter {
    ...
    ArrayList<MainItemDTO> mainItemData = null;
    int count = 0;

    public MakeMainList(ArrayList<MainItemDTO> mainItemData)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        listIconImgView.setImageResource(mainItemData.get(position).getListIconImgView());
        listItemTextView.setText(mainItemData.get(position).getListItemTextView());
